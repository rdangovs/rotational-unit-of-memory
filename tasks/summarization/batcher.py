...
class Example(object):
    ...
    def __init__(self, article, abstract_sentences, vocab, hps, is_sd):
...
class Batcher(object):
    ...
    def fill_example_queue(self):
        ...
        while True:
            ...
            example = Example(article, abstract_sentences, self._vocab, self._hps, self._is_sd)  # Process into an Example.
